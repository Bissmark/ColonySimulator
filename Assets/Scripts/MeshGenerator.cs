...
public class MeshData {
    ...
    public void AddTriangle(int vertexIndexA, int vertexIndexB, int vertexIndexC) {
        if (vertexIndexA < 0 || vertexIndexB < 0 || vertexIndexC < 0) {
            outOfMeshTriangles[outOfMeshTriangleIndex] = vertexIndexA;
            outOfMeshTriangles[outOfMeshTriangleIndex + 1] = vertexIndexB;
            outOfMeshTriangles[outOfMeshTriangleIndex + 2] = vertexIndexC;
